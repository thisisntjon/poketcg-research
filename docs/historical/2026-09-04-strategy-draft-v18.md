...
>
> **This is not the report.** It is draft v18, dated 2026-09-04, preserved for
...
> - Its figure references (`workflow/strategy-report/figures/`, `make_figures.py`,
>   `make_figure6.py`, PR numbers) point at the private working repository and do
>   **not** resolve from this export.
>
> **Read the current report instead:**
> [docs/STRATEGY-WRITEUP.md](../STRATEGY-WRITEUP.md).
>
> Its original body follows unchanged, apart from the removal of one sentence
> claiming it replaced every prior draft.
...
*Kaggle Strategy track · ≤2,000 words · every number carries its interval and its convention (`eval.py:1271`: win rate = (wins + 0.5·draws) / (wins + losses + draws)). Draft v18, 2026-09-04.*
