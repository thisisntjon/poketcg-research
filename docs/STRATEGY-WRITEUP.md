...
![Three research questions, their evidence, and lessons informing the next investigation](current-figures/01-research-factory.png)
...
![Absolute scores and intervention effects across seven tested opponent implementations](current-figures/02-matchup-results.png)
