...
This page explains the submitted public Grimmsnarl player and the experimental Lucario pilot. For the project-developed recurrent learner, see the [current report](STRATEGY-WRITEUP.md#give-the-next-learner-meaningful-choices) and [source excerpts](learner-evidence/README.md).
