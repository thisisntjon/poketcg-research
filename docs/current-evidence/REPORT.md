...
![Implemented decision interface and the uncompleted transfer between experiments and learning](FIGURE-1-MEANINGFUL-CHOICES.png)
...
![Absolute scores and intervention effects across seven opponent implementations](FIGURE-2-MATCHUP-RESULTS.png)
