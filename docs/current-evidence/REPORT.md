...
![One documented Fleet investigation, including checks that repaired the comparison](FIGURE-1-RESEARCH-FACTORY.png)
...
![The entered deck's setup, energy allocation and damage-placement relationships](FIGURE-2-DECK-ENGINE.png)
...
![Pooled effects of card and targeting changes, with their distinct comparison counts](FIGURE-3-DEVELOPMENT-RESULTS.png)
...
![Absolute scores and intervention effects across seven tested opponent implementations](FIGURE-4-MATCHUP-RESULTS.png)
